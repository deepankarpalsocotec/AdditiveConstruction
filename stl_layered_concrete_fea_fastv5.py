# -*- coding: utf-8 -*-
"""
Created on Mon Feb 23 19:06:14 2026
...
# -*- coding: utf-8 -*-
"""
stl_layered_concrete_fea_fastv5.py  (V5)

V5 = V4 + Thermal + Hydration solved ONLY on printed/active material (consistent with mechanics)
     + ParaView .vti.series time-series
     + NO NaN masking (inactive/unprinted regions use ambient T, zero U, alpha=alpha0)

Key modeling choices in V5:
...
Run:
python stl_layered_concrete_fea_fastv5.py --stl statueofliberty2.stl --nx 20 --ny 20 --nz 80 --auto_fit
"""
